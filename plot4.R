...
# create plot
par(mfrow=c(2,2))
plot(qd$Global_active_power~qd$datetime,ylab="Global Active Power", type="l", xlab="")
plot(qd$Voltage~qd$datetime,ylab="Voltage", type="l", xlab="datetime")
...
legend("topright", col=c("black","red","blue"), c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty = c(1,1), cex=0.75, bty="n")
plot(qd$Global_reactive_power~qd$datetime, type="l", xlab="datetime")
